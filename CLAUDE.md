...
- Page background waves: 3-layer system on `.wp-site-blocks` (top-wave SVG transparent / linear-gradient green strip below navbar / bottom-wave SVG with linen rect). Per-viewport top-wave SVG: `background-large-top.svg` (4K ≥2560), `desktop-wave-top.svg` (laptop 769–2559), `mobile-top-wave.svg` (≤768). Bottom: `background-large-bottom.svg` (≥769) / `background-mobile-bottom.svg` (≤768). Tuning knobs as custom properties: `--top-wave-start`, `--top-wave-h`, `--top-wave-zoom`, `--bg-h`. `html { background-color: #459271 }` so overscroll bounce shows green not linen. Old `wave-*.svg` files in `assets/svg/` are superseded — do not reintroduce.
