 ...
 * Slug: gvb/category-all-articles
 * Categories: gvb
 *
 * Mirrors blog-all-articles.php but the inner Query Loop has
 * `"inherit":true` so it picks up the current archive context
 * (category, tag, etc.) instead of fetching every post. Used by
...
<div class="wp-block-group gvb-blog-all" style="padding-top:80px;padding-right:64px;padding-bottom:80px;padding-left:64px">
	...
	<!-- wp:query {"query":{"perPage":6,"pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","sticky":"","inherit":true},"className":"gvb-blog-grid"} -->
	<div class="wp-block-query gvb-blog-grid">
		...
		<!-- wp:query-no-results -->
		<!-- wp:paragraph {"placeholder":"Noch keine Artikel in dieser Kategorie."} -->
		<p></p>
		<!-- /wp:paragraph -->
		<!-- /wp:query-no-results -->
