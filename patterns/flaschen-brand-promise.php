...
<div class="wp-block-group gvb-brand-promise has-gvb-green-background-color has-background" style="padding-top:120px;padding-right:64px;padding-bottom:120px;padding-left:64px">
	...
	<div class="wp-block-group gvb-brand-promise__content">
		...
		<h2 class="wp-block-heading has-text-align-center has-gvb-linen-color has-text-color" style="font-size:60px;font-weight:700;line-height:1.03">Du nimmst's persönlich?</h2>
		<!-- /wp:heading -->

		<!-- wp:paragraph {"align":"center","style":{"typography":{"fontSize":"24px","lineHeight":"1.2","letterSpacing":"0.12px"}},"textColor":"gvb-linen"} -->
		<p class="has-text-align-center has-gvb-linen-color has-text-color" style="font-size:24px;line-height:1.2;letter-spacing:0.12px">So personalisierst du deine Trinkflaschen.</p>
		<!-- /wp:paragraph -->
