...
<!-- wp:group {"className":"gvb-branchen","style":{"spacing":{"padding":{"top":"0","bottom":"40px","left":"20px","right":"20px"}}},"layout":{"type":"default"}} -->
<div class="wp-block-group gvb-branchen" style="padding-top:0;padding-bottom:40px;padding-left:20px;padding-right:20px">
	...
	<h2 class="wp-block-heading gvb-branchen__heading" style="font-size:40px;font-weight:700;line-height:1.08;letter-spacing:0.2px">Deine Branche. Deine Good Vibes.</h2>
	<!-- /wp:heading -->

	<!-- wp:html -->
	<div class="gvb-industry-grid gvb-industry-grid--left-stacked">

		<div class="gvb-industry-card">
			...
			<div class="gvb-industry-card__content">
				...
				<a href="#" class="gvb-btn-sm">Mehr erfahren</a>
			</div>
		</div>
		...
		<div class="gvb-industry-card gvb-industry-card--tall">
