<?php
/**
 * Title: Industrie Hero Sportvereine
 * Slug: gvb/industrie-hero-sportvereine
 * Categories: gvb
 */
...
<div class="wp-block-group gvb-hero gvb-hero--industrie" style="border-radius:20px;margin-left:20px;margin-right:20px;padding-top:120px;padding-right:64px;padding-bottom:120px;padding-left:64px">
	...
	<img class="gvb-hero__bg gvb-hero__bg--sportvereine" src="<?php echo esc_url( $img . '/hero-sportvereine.webp' ); ?>" alt="" aria-hidden="true" />
	...
	<div class="wp-block-group gvb-hero__content" style="margin-left:auto">
		...
		<h1 class="wp-block-heading has-gvb-linen-color has-text-color" style="font-size:clamp(35.641px, 2.228rem + ((1vw - 3.2px) * 2.621), 65px);font-weight:700;line-height:1;letter-spacing:-1.95px">Veranstaltungen,<br>Sport(vereine) und<br>Freizeitaktivitäten</h1>
		<!-- /wp:heading -->
