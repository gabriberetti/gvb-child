...
<div class="wp-block-group gvb-testimonials" style="padding-top:120px;padding-bottom:64px;padding-left:52px;padding-right:52px">
	...
	<!-- wp:group {"className":"gvb-testimonials__header","style":{"spacing":{"margin":{"bottom":"48px"}}},"layout":{"type":"default"}} -->
	<div class="wp-block-group gvb-testimonials__header" style="margin-bottom:48px">
	...
	<div class="wp-block-group gvb-testimonials__cards">
		...
		<div class="gvb-testimonial-card">
