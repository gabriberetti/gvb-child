...
<div class="wp-block-group gvb-hero gvb-hero--faq" style="border-radius:20px;margin-left:20px;margin-right:20px;padding-top:120px;padding-right:64px;padding-bottom:120px;padding-left:64px">
	...
	<img class="gvb-hero__bg gvb-hero__bg--faq" src="<?php echo esc_url( $img . '/hero-faq.jpg' ); ?>" alt="" aria-hidden="true" />
	...
	<div class="wp-block-group gvb-hero__content" style="margin-left:auto">
		...
		<p class="has-gvb-linen-color has-text-color" style="font-size:clamp(32px, 2.222vw, 57px);font-weight:400;line-height:1.15;letter-spacing:0.16px">Got questions? We have answers.</p>
		<!-- /wp:paragraph -->
