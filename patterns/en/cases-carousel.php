...
<div class="wp-block-group gvb-cases gvb-fade-up" style="border-radius:20px;margin-left:20px;margin-right:20px;padding-top:20px;padding-right:52px;padding-bottom:39px;padding-left:52px">
	...
	<div class="wp-block-group gvb-cases__panels">
		...
		<div class="gvb-cases__panel is-layout-flow wp-block-group-is-layout-flow is-active" data-panel="0" data-bg="<?php echo esc_url( $img . '/cases-bg-1.png' ); ?>">
			...
			<h3 class="wp-block-heading has-gvb-linen-color has-text-color" style="font-size:clamp(32px, 2.222vw, 57px);font-weight:400;line-height:1.15;letter-spacing:0.16px">A great<br class="gvb-cases__h3-break"> match.</h3>
			<!-- /wp:heading -->
			...
			<h4 class="wp-block-heading has-gvb-linen-color has-text-color" style="font-size:clamp(40px, 2.778vw, 71px);font-weight:700;line-height:1.08;letter-spacing:0.2px">Good Vibe Bottles<br>X Sample Brand</h4>
			<!-- /wp:heading -->
		</div>
