...
<div class="wp-block-group gvb-testimonials" style="padding-top:120px;padding-bottom:64px;padding-left:52px;padding-right:52px">
	...
	<div class="wp-block-group gvb-testimonials__header gvb-fade-up" style="margin-bottom:48px">
		...
		<h2 class="wp-block-heading has-gvb-graphite-color has-text-color" style="font-size:clamp(40px, 2.778vw, 71px);font-weight:700;line-height:1.08;letter-spacing:0.2px">Good Vibe Bottles are spreading good vibes.</h2>
		<!-- /wp:heading -->
		...
		<p class="has-gvb-graphite-color has-text-color" style="font-size:clamp(32px, 2.222vw, 57px);line-height:1.15;letter-spacing:0.16px">What our customers say</p>
		<!-- /wp:paragraph -->
	...
	<div class="wp-block-group gvb-testimonials__cards">
		...
		<div class="gvb-testimonial-card gvb-fade-up">
			...
			<p class="gvb-testimonial-card__quote">&ldquo;Always well hydrated, no matter where I am.&rdquo;</p>
		...
		<div class="gvb-testimonial-card gvb-fade-up">
			...
			<p class="gvb-testimonial-card__quote">&ldquo;Sustainable reusable bottles for my entire team. Good vibes indeed.&rdquo;</p>
		...
		<div class="gvb-testimonial-card gvb-fade-up">
			...
			<p class="gvb-testimonial-card__quote">&ldquo;With GVB, I&rsquo;m doing something for myself and for the environment.&rdquo;</p>
