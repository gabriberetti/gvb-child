<?php
/**
 * Title: EN Printing Hero
 * Slug: gvb/en-bedrucken-hero
 * Categories: gvb
 */
$img = get_stylesheet_directory_uri() . '/assets/img';
?>

<!-- wp:group {"className":"gvb-hero gvb-hero--bedrucken","style":{"spacing":{"padding":{"top":"120px","bottom":"120px","left":"64px","right":"64px"},"margin":{"left":"20px","right":"20px"}},"border":{"radius":"20px"}},"layout":{"type":"default"}} -->
<div class="wp-block-group gvb-hero gvb-hero--bedrucken" style="border-radius:20px;margin-left:20px;margin-right:20px;padding-top:120px;padding-right:64px;padding-bottom:120px;padding-left:64px">
	...
	<img class="gvb-hero__bg gvb-hero__bg--bedrucken" src="<?php echo esc_url( $img . '/hero-bedrucken.webp' ); ?>" alt="" aria-hidden="true" />
	...
	<div class="wp-block-group gvb-hero__content" style="margin-left:auto">
		...
		<h1 class="wp-block-heading has-gvb-white-color has-text-color" style="font-size:clamp(35.641px, 2.228rem + ((1vw - 3.2px) * 2.621), 65px);font-weight:700;line-height:1;letter-spacing:-1.95px"><span class="has-gvb-linen-color has-inline-color">Your brand.</span><br>Your design.<br>Your vibe.</h1>
		<!-- /wp:heading -->
