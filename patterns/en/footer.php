			...
			<div class="wp-block-columns gvb-footer__nav">
				...
				<div class="wp-block-column">
					...
					<ul class="wp-block-list gvb-footer__nav-list has-gvb-green-color has-text-color" style="font-size:16px;line-height:1.2;letter-spacing:0.08px">
						...
						<li class="gvb-footer__nav-divider"><a href="/en/downloads/#price-list">Price list</a></li>
						<li><a href="/wp-content/uploads/2026/04/Printing-Guideline-GVB-1.pdf" download>Printing guide</a></li>
					</ul>
					<!-- /wp:list -->
				</div>
				<!-- /wp:column -->
