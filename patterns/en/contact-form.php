...
<section id="contact" class="wp-block-group gvb-contact" style="padding-top:60px;padding-right:52px;padding-bottom:80px;padding-left:20px">
	...
	<div class="wp-block-group gvb-contact__header" style="margin-bottom:48px">
		...
		<h2 class="wp-block-heading has-gvb-graphite-color has-text-color" style="font-size:40px;font-weight:700;line-height:1.08;letter-spacing:0.2px">Good vibes, right here, right now!</h2>
		<!-- /wp:heading -->

		<!-- wp:paragraph {"style":{"typography":{"fontSize":"18px","lineHeight":"1.15","letterSpacing":"0.09px"}}} -->
		<p style="font-size:18px;line-height:1.15;letter-spacing:0.09px">Got a feel for our bottles or just curious?<br>Just drop us a message &ndash; we&rsquo;ll get back to you shortly.</p>
		<!-- /wp:paragraph -->
