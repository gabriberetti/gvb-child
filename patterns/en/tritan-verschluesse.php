...
<section class="gvb-borosilikat-verschluesse gvb-tritan-verschluesse">
	...
	<div class="gvb-borosilikat-verschluesse__cards">
		...
		<!-- Classic (single colour, no slider) -->
		<div class="gvb-verschluss-card">
			<div class="gvb-verschluss-card__image">
				<img src="<?php echo esc_url( $img . '/tritan-verschluss-classic.jpg' ); ?>" alt="Classic closure" />
			</div>
			...
			<p class="gvb-verschluss-card__desc">Our reliable and leak-proof classic closure. (included with every bottle)</p>
		</div>
		...
		<div class="gvb-verschluss-card" data-bottle-card>
			<div class="gvb-verschluss-card__image">
				<div class="gvb-verschluss-card__track" data-bottle-track>
					<div class="gvb-verschluss-card__slide">
						<img src="<?php echo esc_url( $img . '/tritan-verschluss-fliptop-schwarz.png' ); ?>" alt="Flip-Top closure &ndash; black" />
					</div>
					<div class="gvb-verschluss-card__slide">
						<img src="<?php echo esc_url( $img . '/tritan-verschluss-fliptop.jpg' ); ?>" alt="Flip-Top closure &ndash; white" />
					</div>
				</div>
			</div>
			<div class="gvb-verschluss-card__header">
				...
				<div class="gvb-verschluss-colors" role="tablist" aria-label="Choose colour">
					...
					<button class="gvb-bottle-card__color-btn" data-bottle-index="1" role="tab" aria-selected="false" aria-label="Colour white">
