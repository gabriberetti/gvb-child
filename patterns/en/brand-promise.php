...
<div class="wp-block-group alignfull gvb-brand-promise has-gvb-green-background-color has-background" style="padding-top:120px;padding-right:64px;padding-bottom:120px;padding-left:64px">
	...
	<div class="wp-block-group gvb-brand-promise__content">
		...
		<h2 class="wp-block-heading has-text-align-center has-gvb-linen-color has-text-color gvb-fade-up" style="font-size:clamp(60px, 4.167vw, 107px);font-weight:700;line-height:1.03">Stayed hydrated today?</h2>
		<!-- /wp:heading -->
		...
		<p class="has-text-align-center has-gvb-linen-color has-text-color gvb-fade-up" style="font-size:clamp(24px, 1.667vw, 43px);line-height:1.2;letter-spacing:0.12px">Discover our bottles.</p>
		<!-- /wp:paragraph -->
