<?php
/**
 * Title: EN Category All Articles
 * Slug: gvb/en-category-all-articles
 * Categories: gvb
 *
 * EN mirror of category-all-articles.php. Inner Query Loop uses
 * `"inherit":true` so it auto-filters to the current en_category
 * archive context. Used by templates/taxonomy-en_category.html.
 */
?>
...
<div class="wp-block-group gvb-blog-all" style="padding-top:80px;padding-right:64px;padding-bottom:80px;padding-left:64px">
	...
	<!-- wp:query {"query":{"perPage":6,"pages":0,"offset":0,"postType":"en_post","order":"desc","orderBy":"date","sticky":"","inherit":true},"className":"gvb-blog-grid"} -->
