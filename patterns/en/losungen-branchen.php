...
<div class="wp-block-group gvb-branchen" style="padding-top:0;padding-bottom:40px">
	...
	<h2 class="wp-block-heading gvb-branchen__heading gvb-fade-up" style="font-size:clamp(40px, 2.778vw, 71px);font-weight:700;line-height:1.08;letter-spacing:0.2px">Your industry. Your good vibes.</h2>
	<!-- /wp:heading -->
	...
	<div class="gvb-industry-grid gvb-industry-grid--left-stacked">
		...
		<div class="gvb-industry-card gvb-fade-up">
				<a class="gvb-industry-card__link" href="<?php echo esc_url( home_url( '/en/sports-clubs/' ) ); ?>" aria-label="Events, sport and leisure activities">Find out more</a>
				<img src="<?php echo esc_url( $img . '/losungen-branchen-2.jpg' ); ?>" alt="Events and sport" />
			<div class="gvb-industry-card__overlay"></div>
			<div class="gvb-industry-card__content">
				<h5>Events, sport and leisure activities</h5>
	...
	<div class="gvb-industry-grid gvb-industry-grid--two-tall">
		...
		<div class="gvb-industry-card gvb-fade-up">
				<a class="gvb-industry-card__link" href="<?php echo esc_url( home_url( '/en/education/' ) ); ?>" aria-label="Public institutions and educational authorities">Find out more</a>
				<img src="<?php echo esc_url( $img . '/losungen-branchen-5.jpg' ); ?>" alt="Educational institutions" />
			<div class="gvb-industry-card__overlay"></div>
			<div class="gvb-industry-card__content">
				<h5>Public institutions and educational authorities</h5>
