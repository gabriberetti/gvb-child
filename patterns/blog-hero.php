...
<div class="wp-block-group gvb-hero gvb-hero--blog" style="border-radius:20px;margin-left:20px;margin-right:20px;padding-top:120px;padding-right:64px;padding-bottom:120px;padding-left:64px">
	...
	<img class="gvb-hero__bg" src="<?php echo esc_url( $img . '/hero-blog.jpg' ); ?>" alt="" aria-hidden="true" onerror="this.src='<?php echo esc_url( $img . '/hero-home.png' ); ?>'" />
	...
	<div class="wp-block-group gvb-hero__content gvb-hero__content--blog">
		...
		<h1 class="wp-block-heading has-gvb-linen-color has-text-color" style="font-size:65px;font-weight:700;line-height:1;letter-spacing:-1.95px">Blog</h1>
		<!-- /wp:heading -->
